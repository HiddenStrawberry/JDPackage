...
def get_ajd_list(url):
    ...
    for each in coupon:
        ...
        type = re.findall('div class="typ-txt">(.*?)</div>', each, re.S)[0]
        ...
        try:
            ...
            print title, type, min_price, off_price, 'RMB', url, 'Available:', data_linkurl
            ...
            print title, type, min_price, off_price, 'RMB',url,data_bean,'JD Bean','Available:', data_linkurl
